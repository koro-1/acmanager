...
public abstract class AccountManger {
  ...
  public abstract void doInLogin(AccountInfo info,ResultCallback callback);
    public abstract  void doInLogout(ResultCallback callback);
    public abstract  void autoLogin(ResultCallback callback);
